...
<hr />
<asp:HiddenField ID="nkimHlasko_hv" runat="server" />
  <asp:Label ID="ctrl_msg_lbl" runat="server"></asp:Label>
<div id="nkim_hlasko_tabs">
    <ul>
        <li><a href="#nkim_hlasko_tab1">Písanie EPČ</a></li>
        <li><a href="#nkim_hlasko_tab2">Zoznam EPČ</a></li>
        <li><a href="#nkim_hlasko_tab3">Hlásenie služby</a></li>
    </ul>

    <div id="nkim_hlasko_tab1">
    <div class="row">
        <div class="one half">
    ...
    <div id="nkim_hlasko_tab3">
    <h2>Písanie hlásenia...</h2>
