...
public partial class is_staze2 : System.Web.UI.Page
{
    ...
    protected void loadStudentClasses()
    {
        ...
        this.yearclass_dl.Controls.Clear();
        for (int i=0; i< cln; i++){
    ...
    protected void saveData(Object sender, EventArgs e)
    {
        ...
        if (status)
        {
            ...
            saveData.Add("note", this.comment_txt.Text.ToString().Trim());
            ...
            for (int row = 0; row < tblLn; row++)
            {
                ...
                if (kruzTmp.IndexOf("|") != -1)
                {
                    ...
                    for (int k = 0; k < kLn; k++)
                    {
                        ...
                        lt.Text = "<p class='alert box'><strong>" + dtTmp[0] + "</strong><br>" + dtTmp[1] + " " + startTime + "-" + endTime;
