    ...
    <div id="header"><h1>Informačný systém Kliniky detskej chirurgie LF UK a DFNsP</h1> </div>
        ...
        <div id="content">
            ...
            <div id="cont_text">
               ...
               Nové heslo:<asp:TextBox ID="passwd1" runat="server" TextMode="Password"></asp:TextBox><br />
               Kontrola hesla:<asp:TextBox ID="passwd2" runat="server" TextMode="Password"></asp:TextBox>
               <br />
