...
Poslednú zmenu vykonal:<strong> <asp:Label ID="last_user" runat="server" Text="Label" ForeColor="#990000"></asp:Label></strong><br />
    ...
    Zaciatok (format hh:mm)   <asp:TextBox ID="workstart_txt" runat="server" OnTextChanged="checkCorrectTime_fnc" AutoPostBack="true"  ></asp:TextBox> 
  </div>
        <div class="one fourth">
             Cas trvanie (minuty) <asp:TextBox ID="worktime_txt" runat="server" Text="15" OnTextChanged="checkCorrectMinutes_fnc" AutoPostBack="true" ></asp:TextBox>
    ...
    Typ:<asp:DropDownList ID="worktype_cb" runat="server">
         ...
         <asp:ListItem Value="sledov">Sledovani</asp:ListItem>
    ...
    <div class="row">
    <asp:CheckBox ID="check_osirix" runat="server" Text="Pridaj do Osirixu" style="display:inline-block;" />
        </div>
