...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row blue box">
        <div class="one third ">
            Vyučujúci:<asp:DropDownList ID="lecturer_dl" runat="server"></asp:DropDownList>
        </div>

        <div class="one third">
            Ročník:<asp:DropDownList ID="yearclass_dl" runat="server"></asp:DropDownList>
        </div>
    ...
    <div class="row green box">
       ...
       <div class="one fourth">
            Začiatok: <asp:TextBox ID="starttime_txt" runat="server" onchange="checkHourFormat('starttime_txt');"></asp:TextBox> (hh:mm)
        </div>
        <div class="one fourth">
            Koniec:<asp:TextBox id="endtime_txt" runat="server" onchange="checkHourFormat('endtime_txt');"></asp:TextBox> (hh:mm)
